...
(function(){
  ...
  /* СОБЫТИЯ — SYSTEM Маркетинг + Монтаж (тренинг 935775378), 24.08–25.09.2026 */
  var СОБЫТИЯ_ММ = [
    ["2026-08-24", "", "Урок 0 + Урок 0.1", ""],
    ["2026-08-24", "", "Монтаж и дизайн видео · Урок 1", ""],
    ["2026-08-26", "", "Позиционирование", ""],
    ["2026-08-26", "", "Съемка видео · Урок 2 + Урок 2.1", ""],
    ["2026-08-28", "", "Анализ ЦА", ""],
    ["2026-08-28", "", "CapCut · Урок №1", ""],
    ["2026-08-31", "", "Анализ конкурентов", ""],
    ["2026-08-31", "", "Программы для монтажа · Урок 3", ""],
    ["2026-09-02", "", "Психология внимания и триггеры · Урок 4", ""],
    ["2026-09-02", "", "CapCut · Урок №2", ""],
    ["2026-09-03", "", "Психология продаж · Урок 5", ""],
    ["2026-09-04", "", "🎁 Бонус: Как общаться с клиентами", ""],
    ["2026-09-04", "", "CapCut · Урок №3", ""],
    ["2026-09-07", "", "CALL TO ACTION · Урок 6", ""],
    ["2026-09-07", "", "CapCut · Урок №4", ""],
    ["2026-09-09", "", "О чем говорить в блоге · Урок 11", ""],
    ["2026-09-09", "", "CapCut · Урок №5", ""],
    ["2026-09-10", "", "Воронки · Урок 7", ""],
    ["2026-09-10", "", "CapCut · Урок №6", ""],
    ["2026-09-11", "", "🎁 Бонус: Психология ведения блога", ""],
    ["2026-09-11", "", "Ошибки монтажа", ""],
    ["2026-09-14", "", "❤️ Разбор ошибок №1", ""],
    ["2026-09-14", "", "❤️ Разбор ошибок №2", ""],
    ["2026-09-16", "", "Доверие · Урок 8", ""],
    ["2026-09-16", "", "CapCut · Урок №7", ""],
    ["2026-09-17", "", "🎁 Бонус: Как работать за высокий чек", ""],
    ["2026-09-18", "", "Где искать клиентов · Урок 9", ""],
    ["2026-09-18", "", "CapCut · Урок №8", ""],
    ["2026-09-21", "", "Работа с брендами · Урок 12 + UGC · Урок 12.1", ""],
    ["2026-09-21", "", "Figma · Уроки №1–3", ""],
    ["2026-09-23", "", "Как вести блог и продавать продукты законно · Урок 13", ""],
    ["2026-09-25", "", "🔥 ФИНИШНАЯ ПРЯМАЯ", ""]
  ];
  ...
  function isMM(){
    if (/stream\/view(?:\/id\/|\?id=)935775378/.test(location.href)) return true;
    return !!document.querySelector('a[href*="/stream/view/id/935775"]');
  }
  function EVS(){ return isMM() ? СОБЫТИЯ_ММ : (isP1() ? СОБЫТИЯ_П1 : СОБЫТИЯ); }
  /* ============================================================ */
  ...
  function mount($){
    ...
    if(/stream\/view(?:\/id\/|\?id=)(935643857|935774562|935775378)/.test(location.href)){
